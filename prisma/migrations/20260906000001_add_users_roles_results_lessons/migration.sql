...
-- AlterTable
ALTER TABLE "Gap" ADD COLUMN     "creatorId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Gap" ADD CONSTRAINT "Gap_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Lesson" ADD CONSTRAINT "Lesson_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
